...
export default function useFetchData(city: string): OpenMeteoResponse | null {
  ...
  const getURL = (selectedCity: string): string => {
    ...
    return `https://api.open-meteo.com/v1/forecast?latitude=${coords.latitude}&longitude=${coords.longitude}&current=temperature_2m,apparent_temperature,relative_humidity_2m,wind_speed_10m`;
  };
